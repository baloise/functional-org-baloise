...
public class AzureProperties {
	...
	public final static String tenant() {return "eb3c68b9-0935-4046-8550-8bcaa4167e2e";}
	public final static String authority() {return format("https://login.microsoftonline.com/%s/", tenant());}
}
